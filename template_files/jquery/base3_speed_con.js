$(document).ready(function(){
 ...
 if(String(navigator.userAgent).indexOf("Edge") != -1){
	...
	$(".handMainBtn").css("font-size", 37+"px");
	...
	$(".handMainBtn").css("font-size", 40+"px");
	
	}else if((window.width1 >= 1101 && window.width1 <= 1300)){ 
	
	$(".handMainBtn").css({"font-size": 38+"px", "margin-top":-95+"px"});
	
	}else if((window.width1 >= 1301 && window.width1 <= 1500)){  
	
	$(".handMainBtn").css({"font-size": 40+"px", "margin-top":-100+"px"});
	
	}else if((window.width1 >= 1501 && window.width1 <= 1800)){  
	
	$(".handMainBtn").css({"font-size": 47+"px", "margin-top":-130+"px"});
	
	}else if((window.width1 >= 1801 && window.width1 <= 2000)){ 
	
	$(".handMainBtn").css({"font-size": 50+"px", "margin-top":-145+"px"});
	
	}else if((window.width1 >= 2000)){  
	
	$(".handMainBtn").css("font-size", 100+"px");
